                                ...
                                <div class="single-wedge">
                                    ...
                                    <div class="footer-links">
                                        <div class="footer-row">
                                            <ul class="align-items-center">
                                                <li class="li">
                                                    <a class="single-link" href="index.html">
                                                        Affiliate
                                                    </a>
                                                </li>
                                                <li class="li">
                                                ...
                                                <li class="li">
                                                    <a class="single-link" href="contact.html">
                                                        Contact Us
                                                    </a>
                                                </li>
                                            </ul>
                                ...
                                <div class="single-wedge ">
                                    ...
                                    <div class="footer-links">
                                        <p class="mail">
                                            ...
                                            contact us at <a href="mailto:demo@example.com">demo@example.com</a>{" "}
                                        </p>
                                        <p class="address">
                                        ...
                                        <p class="phone m-0">
                                            ...
                                            <span>
                                                <a href="tel:0123456789">+ 0 123 456 789</a> <br /> <a href="tel:0123456789">+ 0 123 456 789</a>
                                            </span>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="row flex-md-row-reverse align-items-center">
                                <div class="col-md-6 text-center text-md-end">
                                    <div class="payment-mth">
                                        <a href="#">
                                            <img class="img img-fluid" src="assets/images/icons/payment.png" alt="payment-image" />
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-6 text-center text-md-start">
                                    <p class="copy-text">
                                        {" "}
                                        © 2021 <strong>Mioca.</strong> Made With <i class="fa fa-heart" aria-hidden="true"></i> By{" "}
